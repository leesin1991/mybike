...
class Row extends Abstractic implements \IteratorAggregate, \ArrayAccess, \Countable, JsonSerializable {
    ...
    function alphaId() {
        return \Slim\Common\Util::numberAlpha($this->offsetGet('id')%1024);
    }
