(function($){
	...
	$.fn.dialog = function(options,callBack){
	    ...
	    var _init = function(){
		    ...
		    if(!(opt.buttons.length === 2)){
		     	_this.firstBtn = $("<span class='btn_span btn_Yes"+btn_className+"'></span>").html(opt.buttons[0]).attr({'data-name':opt.buttons[0]}).appendTo(_this.dialog_divOperation);
		    }else{
		     	_this.firstBtn = $("<span class='btn_span btn_Yes"+btn_className+"'></span>").html(opt.buttons[0]).attr({'data-name':opt.buttons[0]}).appendTo(_this.dialog_divOperation);
		     	_this.secondBtn = $("<span class='btn_span btn_No"+btn_className+"'></span>").html(opt.buttons[1]).attr({'data-name':opt.buttons[1]}).appendTo(_this.dialog_divOperation);
		    }
